...
import no.digdir.fdk.search.llm.model.Catalog
import no.digdir.fdk.search.llm.model.Collection
...
import no.digdir.fdk.search.llm.model.Definition
import no.digdir.fdk.search.llm.model.Distribution
import no.digdir.fdk.search.llm.model.EuDataTheme
import no.digdir.fdk.search.llm.model.Event
import no.digdir.fdk.search.llm.model.HarvestMetadata
import no.digdir.fdk.search.llm.model.InformationModel
import no.digdir.fdk.search.llm.model.LocalizedStrings
import no.digdir.fdk.search.llm.model.LosNode
import no.digdir.fdk.search.llm.model.MediaTypeOrExtent
import no.digdir.fdk.search.llm.model.MediaTypeOrExtentType
import no.digdir.fdk.search.llm.model.Organization
import no.digdir.fdk.search.llm.model.ReferenceDataCode
import no.digdir.fdk.search.llm.model.ServiceOrganization
import no.digdir.fdk.search.llm.model.ServiceResource
import no.digdir.fdk.search.llm.model.Temporal
import java.time.LocalDateTime
import java.time.format.DateTimeFormatter

val TEST_NULL_DATASET =
    Dataset(
        uri = "test uri",
        title = null,
        description = null,
...
val TEST_DATASET_ALL_FIELDS =
    TEST_NULL_DATASET.copy(
        title =
            LocalizedStrings(
                "NB Test title",
                "NN Test title",
...
val TEST_DATA_SERVICE_ALL_FIELDS =
    DataService(
        uri = "dataservice-uri",
...
val TEST_INFORMATION_MODEL_ALL_FIELDS =
    InformationModel(
        uri = "infomodel-uri",
