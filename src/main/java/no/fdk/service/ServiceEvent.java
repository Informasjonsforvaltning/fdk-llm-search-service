...
public class ServiceEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private no.fdk.service.ServiceEventType type;
   ...
   */
  public ServiceEvent(no.fdk.service.ServiceEventType type, java.lang.CharSequence harvestRunId, java.lang.CharSequence uri, java.lang.CharSequence fdkId, java.lang.CharSequence graph, java.lang.Long timestamp) {
    this.type = type;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: type = (no.fdk.service.ServiceEventType)value$; break;
   ...
   */
  public no.fdk.service.ServiceEventType getType() {
    return type;
  }
   ...
   */
  public void setType(no.fdk.service.ServiceEventType value) {
    this.type = value;
  }
   ...
   */
  public static no.fdk.service.ServiceEvent.Builder newBuilder() {
    return new no.fdk.service.ServiceEvent.Builder();
  }
   ...
   * @return A new ServiceEvent RecordBuilder
   */
  public static no.fdk.service.ServiceEvent.Builder newBuilder(no.fdk.service.ServiceEvent.Builder other) {
    if (other == null) {
      return new no.fdk.service.ServiceEvent.Builder();
    } else {
      return new no.fdk.service.ServiceEvent.Builder(other);
    }
  }
   ...
   * @return A new ServiceEvent RecordBuilder
   */
  public static no.fdk.service.ServiceEvent.Builder newBuilder(no.fdk.service.ServiceEvent other) {
    if (other == null) {
      return new no.fdk.service.ServiceEvent.Builder();
    } else {
      return new no.fdk.service.ServiceEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ServiceEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(no.fdk.service.ServiceEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(no.fdk.service.ServiceEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
    ...
    /**
      ...
      * @return This builder.
      */
    public no.fdk.service.ServiceEvent.Builder setType(no.fdk.service.ServiceEventType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.fdk.service.ServiceEvent.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.fdk.service.ServiceEvent.Builder setHarvestRunId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.fdk.service.ServiceEvent.Builder clearHarvestRunId() {
      harvestRunId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.fdk.service.ServiceEvent.Builder setUri(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.fdk.service.ServiceEvent.Builder clearUri() {
      uri = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.fdk.service.ServiceEvent.Builder setFdkId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.fdk.service.ServiceEvent.Builder clearFdkId() {
      fdkId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.fdk.service.ServiceEvent.Builder setGraph(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.fdk.service.ServiceEvent.Builder clearGraph() {
      graph = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public no.fdk.service.ServiceEvent.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public no.fdk.service.ServiceEvent.Builder clearTimestamp() {
    ...
    public ServiceEvent build() {
      try {
        ...
        record.type = fieldSetFlags()[0] ? this.type : (no.fdk.service.ServiceEventType) defaultValue(fields()[0]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.type = no.fdk.service.ServiceEventType.values()[in.readEnum()];
